...
public class GrassBlock extends GeneratedBlocks {
	...
	public GrassBlock(Loader loader, Chunk chunk, Vector3f position) {
		super(loader, chunk, position);
			...
			chunk.addTo_chunk_blocks(new Entity(texModel1, position, 0, 0, 0, 1));
			...
			chunk.addTo_chunk_blocks(new Entity(texModel2, position, 0, 0, 0, 1));
			...
			chunk.addTo_chunk_blocks(new Entity(texModel3, position, 0, 0, 0, 1));
		}
